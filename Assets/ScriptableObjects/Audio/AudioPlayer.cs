...
[CreateAssetMenu(fileName = "AudioPlayer", menuName = "Audio/AudioPlayer", order = 0)]
public class AudioPlayer : ScriptableObject
{
    [SerializeField]
    private AudioEmitterDictionary emitters;

    public void Play<AudioEvent>(string name, Transform transform)
    {
        emitters[name].Play(AudioSourcePool.GetAudioSource(transform));
    }

    public void Play<AudioEventSoundtracks>(string eventName, string trackName, Transform transform)
    {
    }
}
...
//     }
// 
//     public void EmitSound(AudioName name, float volume = 1f)
//     {
//         source.PlayOneShot(AudioManager.i.GetClip(name), 1f);
//     }
// }
// 
// /// <summary>
...
//     public void EmitSoundtrack( name, float volume = 1f, float fadeIn = 10f)
//     {
...
//     }
//     #endregion // __PUBLIC_FUNCTIONS__ //
// 
...
//         crossFading = false;
//     }
//     #endregion // __PRIVATE_FUNCTIONS__ //
// }
// 
